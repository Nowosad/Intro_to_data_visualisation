...
```{r, fig.width=3.25, fig.height=4, echo=FALSE}
library(tidyverse)
# library(grid)
# library(gridBase)
# library(gridExtra)
...
- [An introduction to ggplot2](https://rawgit.com/eco-data-science/VisualizingData/master/ggplot2_intro.html)
...
- [Great examples of ggplot2 plots](https://rud.is/b/category/ggplot)
